...
Motor flywheel1 (8, true, AbstractMotor::gearset::blue, AbstractMotor::encoderUnits::degrees);
Motor flywheel2 (7, true, AbstractMotor::gearset::blue, AbstractMotor::encoderUnits::degrees);
